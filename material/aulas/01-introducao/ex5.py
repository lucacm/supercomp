...
# print("tempos de processamento do busca-local-2 {0}".format(times))
# print("tamanhos de entrada do busca-local-2 {0}".format(sizes))

grafico2 = plt.plot(sizes, times, label="busca-local-2")
#plt.show()